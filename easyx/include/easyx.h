...
void outtextxy(int x, int y, const char *str);				// Output a string at the specified location
...
void settextstyle(int nHeight, int nWidth, const char *lpszFace);
...
void settextstyle(const wchar_t *font);	// Set current text style
